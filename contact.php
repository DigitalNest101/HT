<?php include('./partials/header.php')  ?>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/1.jpg');">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>Our Address</h3>
              <p>4-6-67/1, Balanagar "X" Roads , Hyderabad - 500037 , Telangana</p>
            </div>
          </div><!-- End Info Item -->
